...
public class GatewayFlowRuleController {
    ...
    private PersistentRuleApiClient<GatewayFlowRuleEntity> persistentApiClient;
    ...
    public Result<List<GatewayFlowRuleEntity>> queryFlowRules(String app, String ip, Integer port) {
        ...
        try {
            ...
            if (persistentApiClient == null) {
                ...
                rules = persistentApiClient.fetch(app, RuleConfigTypeEnum.GATEWAY_FLOW);
            }
    ...
    private boolean publishRules(String app, String ip, Integer port) {
        ...
        if (persistentApiClient != null) {
            try {
                persistentApiClient.publish(app, RuleConfigTypeEnum.GATEWAY_FLOW, rules);
            } catch (Exception e) {
                logger.error("推送到nacos异常:{}", e.getMessage());
            }
        }
